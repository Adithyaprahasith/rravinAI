# rravinAI - Data Analysis Agent

## Background
rravin - an AI agent which analyzes datasets, builds visualizations, reports, recommends actions and generates executive reports from the data. Save time from building dashboards, reports, and writing complex queries with a single prompt.
