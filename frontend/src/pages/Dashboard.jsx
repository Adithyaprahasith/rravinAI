      ...
      <main className="px-6 md:px-8 py-6">
        <Tabs defaultValue="dashboard" className="space-y-6">
          ...
          <TabsContent value="dashboard" className="space-y-6 animate-fade-in">
            ...
            {analysis.data_cleaning && analysis.data_cleaning.length > 0 && (
              <div className="card-elevated p-5 border-l-4 border-l-green-500">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {analysis.data_cleaning.map((report, idx) => (
                        <div key={idx} className="bg-slate-50 rounded-lg p-4">
                          ...
                          <div className="grid grid-cols-2 gap-2 text-xs mb-3">
                            <div>
                              ...
                              <span className="ml-1 font-medium text-slate-700">{report.original_rows} rows</span>
                            </div>
                            <div>
                              <span className="text-slate-500">Final:</span>
                              <span className="ml-1 font-medium text-slate-700">{report.final_rows} rows</span>
                            </div>
                            <div>
                              <span className="text-slate-500">Removed:</span>
                              <span className="ml-1 font-medium text-red-600">{report.rows_removed} rows</span>
                            </div>
                            <div>
                              <span className="text-slate-500">Quality:</span>
                              <span className={`ml-1 font-medium ${report.data_quality_score >= 90 ? 'text-green-600' : report.data_quality_score >= 70 ? 'text-amber-600' : 'text-red-600'}`}>
                            ...
                            <div className="border-t border-slate-200 pt-2 mt-2">
                              ...
                              <ul className="text-xs text-slate-600 space-y-0.5">
                                ...
                                {report.actions_taken.length > 3 && (
                                  <li className="text-slate-400">+{report.actions_taken.length - 3} more actions</li>
                                )}
                              </ul>
                            </div>
                          )}
